...
public class PosImprimir_Venta {
    ...
    private static String v6_redondeo = "0";
    ...
    private void cargar_datos_venta(Connection conn, int idventa) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                v6_redondeo = rs.getString("redondeo");
    ...
    private String cargar_datos_para_mensaje_textarea() {
        ...
        mensaje_impresora = mensaje_impresora + "REDONDEO :" + tabular + tabular + v6_redondeo + saltolinea;
    ...
    private static void crear_archivo_texto_impresion() throws PrintException, FileNotFoundException, IOException {
        ...
        printer.printTextWrap(12 + tempfila, 12, jsprint.getSep_inicio(), totalColumna, "OBSERVACION: " + v7_observacion);
        printer.printTextWrap(13 + tempfila, 13, jsprint.getSep_inicio(), totalColumna, "TOTAL :");
        printer.printTextWrap(13 + tempfila, 13, jsprint.getSep_total_gral(), totalColumna, v6_monto);
        printer.printTextWrap(14 + tempfila, 14, jsprint.getSep_inicio(), totalColumna, "REDONDEO :");
        printer.printTextWrap(14 + tempfila, 14, jsprint.getSep_total_gral(), totalColumna, v6_redondeo);
