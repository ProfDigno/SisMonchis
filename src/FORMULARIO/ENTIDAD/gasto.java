...
public class gasto {
    ...
    public String toString() {
        return "gasto{" + "idgasto=" + idgasto + ", fecha_emision=" + fecha_emision + ", descripcion=" + descripcion + ", monto_gasto=" + monto_gasto + ", estado=" + estado + ", fk_idgasto_tipo=" + fk_idgasto_tipo + ", fk_idusuario=" + fk_idusuario + '}';
    }
