...
public class FrmCompra extends javax.swing.JInternalFrame {
    ...
    String insu_tabla = "producto p,producto_unidad u,producto_marca pm ";
    String insu_mostrar = "(pm.nombre||'-'||u.nombre||'-'||p.nombre) as producto";
    String insu_buscar = "p.fk_idproducto_marca=pm.idproducto_marca \n"
...
//    private String indice_select;
    ...
    void crear_item_producto() {
        String dato[] = {"id", "MARCA-UNID-PRODUCTO", "UNIDAD", "PRE_COMPRA", "CANTIDAD", "SUBTOTAL"};
...
//        indice_creado = eveut.getString_crear_indice();
    ...
    void seleccionar_buscar_insumo() {
        ...
        ipdao.cargar_producto_por_idproducto(connLocal, insup, idinsumo_producto);
        txtbuscar_insumo_producto.setText(insup.getC20_marca() + "-" + insup.getC18_unidad() + "-" + insup.getC3nombre());
        txtinsumo_stock.setText(String.valueOf((int)insup.getC8stock()));
        txtinsumo_unidad.setText(insup.getC18_unidad());
        int precio_compra = (int) insup.getC7precio_compra();
        txtinsumo_pre_com.setText(String.valueOf(precio_compra));
        txtinsumo_cant.setBackground(Color.ORANGE);
        txtinsumo_cant.setText("1");
        txtinsumo_cant.grabFocus();
    }

    void carcar_producto_codbarra() {
        if (txtcodbarra.getText().trim().length() > 0) {
            if (ipdao.getBoolean_cargar_producto_por_codbarra(connLocal, insup, txtcodbarra.getText())) {
                idinsumo_producto=insup.getC1idproducto();
                txtbuscar_insumo_producto.setText(insup.getC20_marca() + "-" + insup.getC18_unidad() + "-" + insup.getC3nombre());
                txtinsumo_stock.setText(String.valueOf((int)insup.getC8stock()));
                txtinsumo_unidad.setText(insup.getC18_unidad());
                int precio_compra = (int) insup.getC7precio_compra();
    ...
    void calcular_subtotal_item() {
        if (validar_subtotal()) {
            try {
                int cantidad = Integer.parseInt(txtinsumo_cant.getText());
                int precio = Integer.parseInt(txtinsumo_pre_com.getText());
...
//            ipdao.cargar_producto(insup, idinsumo_producto);
            ...
            try {
                ...
                insup.setC1idproducto(idinsumo_producto);
                insup.setC7precio_compra(DprecioUni);
    ...
    void cargar_datos_caja() {
        ...
        caja.setC12id_origen(idcompra_insumo_ultimo);
        caja.setC13tabla_origen("COMPRA");
        //        caja.setC14cierre("C");
...
//            indice_select = evejt.getString_select(tblcompra_insumo, 1);
    ...
    void anular_compra(int idcompra_insumo) {
        compi.setC1idcompra(idcompra_insumo);
        compi.setC3estado(est_ANULADO);
//        compi.setC9nro_nota(indice);
...
//                }
    ...
    public String filtro_estado() {
        ...
        if (jCestado_confirmado.isSelected()) {
            ...
            estado = condi + " c.estado='CONFIRMADO' ";
            sumaestado = sumaestado + estado;
        }
    ...
    private void initComponents() {
        ...
        txtinsumo_stock = new javax.swing.JTextField();
                ...
                .addGroup(panel_insertar_seg_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_insertar_seg_compraLayout.createSequentialGroup()
                        .addGroup(panel_insertar_seg_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panel_insertar_seg_compraLayout.createSequentialGroup()
                                .addComponent(jFtotal_guarani, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panel_insertar_seg_compraLayout.setVerticalGroup(
            ...
            .addGroup(panel_insertar_seg_compraLayout.createSequentialGroup()
                ...
                .addComponent(jLabel7)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_insertar_seg_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnsumar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnconfirmar_insertar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        txtinsumo_stock.setEditable(false);
        txtinsumo_stock.setBackground(new java.awt.Color(204, 204, 255));
        txtinsumo_stock.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
                ...
                .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panel_insertar_pri_compraLayout.createSequentialGroup()
                        ...
                        .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtbuscar_insumo_producto, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnnuevo_insumo, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel3)
                            .addComponent(txtinsumo_unidad, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(6, 6, 6)
                        .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel16)
                            .addComponent(txtinsumo_stock, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_insertar_pri_compraLayout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(panel_insertar_pri_compraLayout.createSequentialGroup()
                                .addGap(4, 4, 4)
                                .addComponent(txtinsumo_cant, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_insertar_pri_compraLayout.createSequentialGroup()
                        ...
                        .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtinsumo_unidad, javax.swing.GroupLayout.Alignment.CENTER)
                            .addComponent(txtcodbarra, javax.swing.GroupLayout.Alignment.CENTER, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtbuscar_insumo_producto, javax.swing.GroupLayout.Alignment.CENTER, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(panel_insertar_pri_compraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(txtinsumo_pre_com, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtinsumo_cant, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))))
                    .addGroup(panel_insertar_pri_compraLayout.createSequentialGroup()
                        .addComponent(jLabel6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        evetbl.maximizar_jinternal(this);
    ...
    private void jCestado_emitidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCestado_emitidoActionPerformed
        // TODO add your handling code here:
        cidao.actualizar_tabla_compra_buscar(connLocal, tblcompra_insumo, filtro_estado());
...
//                cidao.actualizar_tabla_compra_insumo(connLocal, tblcompra_insumo, filtro);
    ...
    private javax.swing.JTextField txtinsumo_stock;
