...
//        primer_finanza();
    ...
    void actualizacion_version_v1() {
        ...
        String sql = "DO $$ \n"
                + "    BEGIN\n"
                + "        BEGIN\n"
                + " ALTER TABLE venta_alquiler ADD COLUMN monto_alquilado_reservado NUMERIC(15,0) DEFAULT 0;\n "
...
//                + " ALTER TABLE cliente ADD COLUMN escredito boolean DEFAULT true; \n"
...
//                + " ALTER TABLE cliente ADD COLUMN dia_limite_credito INTEGER DEFAULT 30; \n"
