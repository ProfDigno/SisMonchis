...
public class DAO_recibo_pago_cliente {
	...
	private String sql_select = "SELECT idrecibo_pago_cliente,fecha_emision,descripcion,monto_recibo_pago,monto_letra,estado,fk_idcliente,fk_idusuario FROM recibo_pago_cliente order by 1 desc;";
